...
CREATE UNIQUE INDEX `uq_td_cor_olho_nme_cor_olho` ON `RPG_unamed`.`td_cor_olho` (`nme_cor_olho` ASC);
...
CREATE INDEX `fk_tb_personagem_td_cor_olho` ON `RPG_unamed`.`tb_personagem` (`cod_cor_olho` ASC);
