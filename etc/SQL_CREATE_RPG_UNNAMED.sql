...
-- Schema RPG_unamed
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `RPG_unamed` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_equipamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_alinhamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_classe` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_raca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`tb_personagem` ;
...
CREATE TABLE IF NOT EXISTS `RPG_unamed`.`tb_personagem` (
  ...
  `alt_personagem` DECIMAL(3,2) NOT NULL,
  `dsc_cabelo_personagem` VARCHAR(200) NOT NULL,
  `img_personagem` VARCHAR(255) NOT NULL,
  ...
  `qtd_vida_total_personagem` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_equipavel` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`tb_sala` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_tipo_perfil` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`tb_usuario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_papel_sala` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_perfil_sala` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_atributo` ;

CREATE TABLE IF NOT EXISTS `RPG_unamed`.`td_atributo` (
  `idt_atributo` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_personagem_atributo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_linguagem` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_personagem_linguagem` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_magia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_personagem_magia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_item` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_utilizaveis` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_divindade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_culto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`td_pericia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_aptidao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`tb_custom` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RPG_unamed`.`ta_personalizavel` ;
