...
<div id="alignModal" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Lista de Alinhamentos</h4>
            </div>
            <div class="modal-body">
                <table>
                    <tbody>
                    ...
                    <?php
                    foreach ($alignments as $singleAlignment) {
                        ?>
                        <tr>
                            <td><strong><?= $singleAlignment['nme_alinhamento'] ?></strong></td>
                            <td><?= $singleAlignment['dsc_alinhamento'] ?></td>
                        </tr>
                        <?php
                    }
                    ?>
